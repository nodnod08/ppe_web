  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        ...
        <ul class="list-unstyled">
          <li>GHGs (green house gases) emissions from manufacturing a single mono toner cartridge have been calculated to approximately 4.8 kg CO2; per cartridge.</li>
          <li>Each year over 350 million cartridges are thrown out to landfills.</li>
          <li>By 2012 500 million laser cartridges and 1.8 billion ink cartridges will be dumped in landfills.</li>
          <li>Each cartridge becomes 3.5 pounds of solid waste sitting in a landfill and can take up to 450 to 1000 years to decompose.</li>
        </ul>
      </div>
    </div>
    <br />
